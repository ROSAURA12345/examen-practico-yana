...
def grafico_top10_ssh() -> None:
    if not AUTH_LOG.exists():
        raise FileNotFoundError("Falta lab1/auth.log. Ejecuta ./scripts/descargar_datos.sh")
...
def cargar_access() -> pd.DataFrame:
    ...
    if not ACCESS_LOG.exists():
        raise FileNotFoundError("Falta lab1/access.log. Ejecuta ./scripts/descargar_datos.sh")
